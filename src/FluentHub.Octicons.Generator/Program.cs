	...
	public class Program
	{
		static void Main(string[] args)
		{
			...
			if (args.Length != 3)
			{
				...
				message.AppendLine();
				message.AppendLine("ExpressHub Octicons Generator");
				message.AppendLine("--------------------------------------------------");
				message.AppendLine();
		...
		private static void GenerateXamlEntities(string path, string output)
		{
			...
			xamlTemplateBegining.AppendLine(@$"﻿<!--  Copyright (c) 2022-2024 Broduer. Licensed under the MIT License. See the LICENSE.  -->");
		...
		private static void GenerateCSharpEnumEntities(string path, string output)
		{
			...
			stringBuilder.AppendLine(@$"﻿// Copyright (c) Broduer");
